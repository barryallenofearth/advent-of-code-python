...
class HandOfCards:
    ...
    def __init__(self, original_hand: str, bid: int):
        ...
        print(original_hand, self.type_value)
    ...
    def get_type_value(self) -> int:
        def no_joker_ranking(list_of_counted_chars: list[tuple[str:int]]) -> int:
        ...
        if number_of_jokers == 5 or number_of_jokers == 4:
            return 6

        hand_without_jokers = self.hand.replace("J", "")
        list_of_counted_chars = string_utils.sort_counted_chars(string_utils.count_chars_in_string(hand_without_jokers), use_char_value_as_tie_breaker=False)
        if number_of_jokers == 0:
            return no_joker_ranking(list_of_counted_chars)
        elif number_of_jokers == 3 and list_of_counted_chars[-1][1] == 2:
            return 6
        elif number_of_jokers == 3 and list_of_counted_chars[-1][1] == 1:
            return 5
        elif number_of_jokers == 2 and list_of_counted_chars[-1][1] == 3:
            return 6
        elif number_of_jokers == 2 and list_of_counted_chars[-1][1] == 2:
            return 5
        elif number_of_jokers == 2 and list_of_counted_chars[-1][1] == 1:
            return 3
        elif number_of_jokers == 1 and list_of_counted_chars[-1][1] == 4:
            return 6
        elif number_of_jokers == 1 and list_of_counted_chars[-1][1] == 3:
            return 5
        elif number_of_jokers == 1 and list_of_counted_chars[-1][1] == 2 and list_of_counted_chars[-2][1] == 2:
            return 4
        elif number_of_jokers == 1 and list_of_counted_chars[-1][1] == 2:
            return 3
        elif number_of_jokers == 1 and list_of_counted_chars[-1][1] == 1:
            return 1
